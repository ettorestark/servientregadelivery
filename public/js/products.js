...
$(document).on('click', '.title-product', function () {
  ...
  $dimensions = $("#dimensions_" + $id_product).val(); //Sett values in modal
...
module.exports = __webpack_require__(/*! /home/joseph/Sites/shopify-servientrega/resources/js/products.js */"./resources/js/products.js");
