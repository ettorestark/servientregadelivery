...
/***/ "./resources/js/servientregadelivery-v1.0.js":
/*!***************************************************!*\
  !*** ./resources/js/servientregadelivery-v1.0.js ***!
  \***************************************************/
/*! no static exports found */
...
(function () {
  ...
  var ServientregaDelivery = function ServientregaDelivery($) {
    var $this = this; // Variablesen

    $this.version = '2.0.38';
    $this.candebug = false;
    $this.urlBase = "https://servientregadelivery.vexecommerce.com"; //$this.urlBase        = "https://5b1615699d31.ngrok.io";
    ...
    this.requestSnippet = function () {
      ...
      $.ajax({
        ...
        data: {
          ...
          'productlist': JSON.stringify(product_list),
          'variantlist': JSON.stringify(variants_list),
    ...
    this.setWorkinDays = function (workingdays) {
      ...
      if ($("#cbScheduleday").find('option:eq(0)').prop('disabled') == 'disabled' || $("#cbScheduleday").find('option:eq(0)').prop('immediately') == false) {
    ...
    this.getWorkingTimes = function (day) {
      ...
      $.ajax({
        ...
        data: {
          'shop': window["Shopify"].shop,
          'day': day,
          'products': JSON.stringify(product_list)
        },
        dataType: 'json',
        crossDomain: true,
        beforeSend: function beforeSend(xhr) {
  ...
  ServientregaDelivery(__webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js"));
})();
...
/***/ 3:
/*!*********************************************************!*\
  !*** multi ./resources/js/servientregadelivery-v1.0.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/joseph/Sites/shopify-servientrega/resources/js/servientregadelivery-v1.0.js */"./resources/js/servientregadelivery-v1.0.js");
