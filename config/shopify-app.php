...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_themes,write_themes, read_orders, write_orders, write_fulfillments, write_shipping, read_script_tags, write_script_tags,unauthenticated_read_product_listings, unauthenticated_read_product_tags'),
    ...
    */
    ...
    'webhooks' => [
        [
            ...
            'address' => env('SHOPIFY_APP_URL').'/webhook/app-uninstalled'
        ],
    ],
